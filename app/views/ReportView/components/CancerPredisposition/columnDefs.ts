...
},
{
  ...
  field: 'disease',
  hide: false,
  cellRenderer: ArrayCell('kbMatchedStatements.disease', false),
},
{
  headerName: 'Association',
  colId: 'relevance',
  field: 'relevance',
  cellRenderer: ArrayCell('kbMatchedStatements.relevance', false),
  hide: false,
},
{
  headerName: 'Context',
  colId: 'context',
  field: 'context',
  cellRenderer: ArrayCell('kbMatchedStatements.context', false),
  hide: false,
},
{
  headerName: 'PMID',
  ...
  field: 'reference',
  hide: false,
  cellRenderer: ArrayCell('kbMatchedStatements.reference', true),
},
{
  headerName: 'Category',
  colId: 'category',
  field: 'category',
  cellRenderer: ArrayCell('kbMatchedStatements.category', false),
  hide: true,
},
{
  ...
  colId: 'evidenceLevel',
  field: 'evidenceLevel',
  cellRenderer: ArrayCell('kbMatchedStatements.evidenceLevel', false),
  hide: false,
},
{
  ...
  cellRenderer: ArrayCell('kbMatchedStatements.iprEvidenceLevel', false),
  hide: false,
},
{
  headerName: 'Matched Cancer',
  field: 'matchedCancer',
  cellRenderer: ArrayCell('kbMatchedStatements.matchedCancer', false),
  hide: true,
},
{
  headerName: 'Inferred',
...
},
{
  headerName: 'Sample',
  field: 'sample',
  cellRenderer: ArrayCell('kbMatchedStatements.sample', false),
  hide: false,
},
{
